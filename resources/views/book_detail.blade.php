                ...
                <div class="col-md-8">
                    ...
                    <div class="row mt-4">
                        ...
                        @if ($relatedBook->isNotEmpty())
                            @foreach ($relatedBook as $relatedBooks)
                            <div class="col-md-4 col-lg-4 mb-4">
                                <div class="card border-0 shadow-lg">
                                    <a href="{{route('book.detail',$relatedBooks->id)}}">
                                        @if (!empty($relatedBooks->image))
                                            <img src={{asset('uploads/books/'.$relatedBooks->image)}} alt="" class="card-img-top">
                                        @else
                                            <img src={{asset('images/Noimage.jpg')}} alt="" class="card-img-top" style="height: 420px;">
                                        @endif
                                    </a>
                                    
                                    <div class="card-body">
                                        <h3 class="h4 heading"><a href="{{route('book.detail',$relatedBooks->id)}}">{{$relatedBooks->title}}</a></h3>
                                        <p>by {{$relatedBooks->author}}</p>
                                        <div class="star-rating d-inline-flex ml-2" title="">
...
<div class="modal fade " id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <form action="" id="book-review-form" name="book-review-form">
...
@section('script')
    <script>
        $('#book-review-form').submit(function(e){
            e.preventDefault();
            $.ajax({
                ...
                data:$('#book-review-form').serializeArray(),
